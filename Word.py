class Word:
    ...
    def categorize_word(self, word):
        personal_keywords = open('scripts\personal-keywords.txt', encoding='UTF-8').read().splitlines()
        sensible_keywords = open('scripts\sensible-keywords.txt', encoding='UTF-8').read().splitlines()        
        weight = 0
